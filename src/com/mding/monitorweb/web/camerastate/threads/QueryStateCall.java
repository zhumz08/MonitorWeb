package com.mding.monitorweb.web.camerastate.threads;
...
import com.mding.monitorweb.common.DateUtils;
import com.mding.monitorweb.common.MvpConfig;
import com.mding.monitorweb.common.dbcp.DBConnFactory;
import com.mding.monitorweb.web.camerastate.CameraStateDao;
...
public class QueryStateCall implements Callable<Integer> {
	...
	private int[] syncCameraStateHistory(CameraStateDao dao) {
		...
		dao.updateStateConfig(MvpConfig.syncTime, DateUtils.parse(date));
